...
|定义并判定实时全模态 AI 视频语音通话体验
|xref:books/08-realtime-omnimodal-call-experience-spec/book.adoc[08 实时全模态视频通话体验规约与符合性判定]
|它把摄像头、麦克风、视觉现场、自然语音回应、打断、上下文和公共投影写成可审查的体验规约。
|===
...
* xref:books/08-realtime-omnimodal-call-experience-spec/book.adoc[08 实时全模态视频通话体验规约与符合性判定]：定义并判定实时全模态 AI 视频语音通话体验。
...
* 写可审查的实时全模态 AI 视频语音通话体验规约：看 xref:books/08-realtime-omnimodal-call-experience-spec/book.adoc[08 实时全模态视频通话体验规约与符合性判定]。
